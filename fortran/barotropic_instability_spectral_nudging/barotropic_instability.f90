module global
    character(200), parameter :: DATA_DIR_PATH = "/workspace/data/fortran/barotropic_instability_spectral_nudging"
...
program main
    ...
    integer, parameter :: WAVENUMBERS(3) = (/ 10, 21, 42 /)
    integer, parameter :: X_GRID_NUMS(3) = (/ 32, 64, 128 /)
    integer, parameter :: Y_GRID_NUMS(3) = (/ 16, 32, 64 /)
    ...
    csv_path = "/workspace/fortran/barotropic_instability_spectral_nudging/config/" // trim(CONFIG_NAME) // ".csv"
