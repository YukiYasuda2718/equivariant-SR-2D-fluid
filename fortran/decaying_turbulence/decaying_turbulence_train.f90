module global
    implicit none
    character(200), parameter :: DATA_DIR_PATH = "/workspace/data/fortran/decaying_turbulence/train"
    ...
    integer(8), parameter :: INIT_SEED = 42
    integer, parameter :: NUM_SEEDS = 1000

    real(8), parameter :: AMPLITUDE0 = 9.0d0
